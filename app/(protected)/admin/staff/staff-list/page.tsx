              ...
              <Table className="table-fixed w-full">
                <TableHeader>
                  <TableRow className="bg-slate-50 dark:bg-slate-800">
                    ...
                    <TableHead className="font-medium py-3 hidden md:table-cell text-center w-[12%] whitespace-nowrap">
                      Số điện thoại
                    </TableHead>
                  ...
                  {currentData.length === 0 ? (
                    ...
                    currentData.map((staff) => (
                      ...
                      >
                        ...
                        {/* Số điện thoại */}
                        <TableCell className="hidden md:table-cell text-center truncate w-[12%]">
                          {staff.phoneNumber}
                        </TableCell>
