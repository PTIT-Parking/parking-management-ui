...
export default function ResetPasswordForm() {
  ...
  if (isValidating) {
    return (
      <div className="w-full h-screen flex items-center justify-center p-4 bg-gray-50"> {/* Nền tối giống ảnh login */}
        <Card className="w-[400px] bg-[#22242B] text-white border border-[#3A3C42]"> {/* Card nền tối, viền nhẹ */}
          <CardHeader>
  ...
  return (
    <>
      <div className="w-full h-screen flex items-center justify-center p-4 bg-gray-50">
        <Card className="w-[400px] bg-[#22242B] text-white border border-[#3A3C42]"> {/* Card nền tối */}
          <CardHeader>
            <CardTitle className="text-center text-2xl font-bold">
              {isSuccess
              ...
              <Form {...form}>
                ...
                >
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-neutral-300">Mật khẩu mới</FormLabel>
                        <FormControl>
                          <Input
                            type="password"
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-neutral-300">Xác nhận mật khẩu</FormLabel>
                        <FormControl>
                          <Input
                            type="password"
                  ...
                  <Button type="submit" className="w-full bg-[#FFD700] hover:bg-[#E5C100] text-black" disabled={isLoading}>
                    {isLoading ? (
                      <>
      ...
      <AlertDialog open={showConfirmDialog} onOpenChange={setShowConfirmDialog}>
        <AlertDialogContent className="bg-[#22242B] text-white border-[#3A3C42]">
          <AlertDialogHeader>
          ...
          <AlertDialogFooter>
            <AlertDialogCancel className="bg-[#3A3C42] hover:bg-[#4A4C52] border-[#4A4C52] text-white">Hủy</AlertDialogCancel>
            <AlertDialogAction
